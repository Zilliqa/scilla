...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7508a8670d0d3e5015b79b19d92ef14f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Elliptic curve library secp256k1 wrapper";
          description =
            Some [OASISText.Para "Elliptic curve library secp256k1 wrapper"];
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["secp256k1_wrap.c"];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-O"])];
                      bs_cclib = [(OASISExpr.EBool true, ["-lsecp256k1"])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "secp256k1"];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "ocamldoc"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\247\006\018\007qH\163\218\022\220\003Bl\022\204F";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
