  ...
  module BuiltInDictionary = struct
    ...
    *)
    ...
    let built_in_multidict : builtin -> built_in_record list = function
      ...
      | Builtin_bitwise_and -> [IntBuiltins.binop_arity, IntBuiltins.binop_type, IntBuiltins.binop_elab;
                        UintBuiltins.binop_arity, UintBuiltins.binop_type, UintBuiltins.binop_elab]
      | Builtin_bitwise_xor -> [IntBuiltins.binop_arity, IntBuiltins.binop_type, IntBuiltins.binop_elab;
                        UintBuiltins.binop_arity, UintBuiltins.binop_type, UintBuiltins.binop_elab]
