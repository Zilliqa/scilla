...
module Uint256 = struct
  ...
  let of_uint32 a = { low = Uint128.of_uint32 a; high = Uint128.zero }

  let of_uint64 a = { low = Uint128.of_uint64 a; high = Uint128.zero }

  let of_uint128 a = { low = Uint128.of_uint128 a; high = Uint128.zero }
end
