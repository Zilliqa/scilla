...
module type TypeUtilities = sig
  ...
  module TypeUtilities : sig
    ...
    val literal_type : TULiteral.t -> (TULiteral.LType.t, scilla_error list) result

    val is_wellformed_lit : TULiteral.t -> (TULiteral.LType.t, scilla_error list) result

    (* Useful generic types *)
    val fun_typ : TULiteral.LType.t -> TULiteral.LType.t -> TULiteral.LType.t

    val tvar : string -> TULiteral.LType.t

    val tfun_typ : string -> TULiteral.LType.t -> TULiteral.LType.t

    val map_typ : TULiteral.LType.t -> TULiteral.LType.t -> TULiteral.LType.t

    val unit_typ : TULiteral.LType.t

    (****************************************************************)
    (*                       Type sanitization                      *)
    (****************************************************************)

    val is_storable_type : TULiteral.LType.t -> bool

    val is_serializable_type : TULiteral.LType.t -> bool

    val is_ground_type : TULiteral.LType.t -> bool

    val is_non_map_ground_type : TULiteral.LType.t -> bool

    val get_msgevnt_type :
      (string * 'a) sexp_list -> (TULiteral.LType.t, scilla_error sexp_list) result

    val map_access_type : TULiteral.LType.t -> int -> (TULiteral.LType.t, scilla_error list) result

    val map_depth : TULiteral.LType.t -> int

    (****************************************************************)
    (*             Utility function for matching types              *)
    (****************************************************************)

    val type_equiv_list : TULiteral.LType.t list -> TULiteral.LType.t list -> bool
    ...
    val assert_type_equiv : TULiteral.LType.t -> TULiteral.LType.t -> (unit, scilla_error list) result
    ...
    val fun_type_applies :
      TULiteral.LType.t -> TULiteral.LType.t list -> (TULiteral.LType.t, scilla_error list) result

    (* Applying a procedure "type" *)
    val proc_type_applies :
      TULiteral.LType.t list -> TULiteral.LType.t list -> (unit list, scilla_error list) result
    ...
    val elab_tfun_with_args :
      TULiteral.LType.t ->
      TULiteral.LType.t list ->
      Stdint.uint64 ->
      ( TULiteral.LType.t * Stdint.uint64,
        typeCheckerErrorType * scilla_error list * Stdint.uint64 )
        result

    val pp_typ_list : TULiteral.LType.t list -> string
    ...
    val apply_type_subst : (string * TULiteral.LType.t) list -> TULiteral.LType.t -> TULiteral.LType.t

    (*  Get elaborated type for a constructor and list of type arguments *)
    val elab_constr_type :
      string -> TULiteral.LType.t list -> (TULiteral.LType.t, scilla_error list) result
    ...
    val constr_pattern_arg_types :
      TULiteral.LType.t -> string -> (TULiteral.LType.t list, scilla_error list) result

    val validate_param_length :
      string -> int -> int -> (unit, scilla_error list) result

    val assert_all_same_type : TULiteral.LType.t list -> (unit, scilla_error list) result
  end
...
module MkTypeUtilities : functor (TULiteral : Literal) -> TypeUtilities
