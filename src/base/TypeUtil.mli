...
module TypeUtilities : sig
  ...
  val mk_type_error0 : kind:string -> ?inst:string -> typeCheckerErrorType * scilla_error list

  val mk_type_error1 : kind:string -> ?inst:string -> loc -> typeCheckerErrorType * scilla_error list
