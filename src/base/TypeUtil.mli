...
module TypeUtilities (Name : QualifiedName) : sig

  module TUIdentifier : Identifier
  ...
  module type MakeTEnvFunctor = functor (Q : QualifiedTypes) (R : Rep) -> sig
    ...
    module TEnv : sig
      ...
      val addT : t -> R.rep TUIdentifier.t -> Type.t -> t

      (* Add to many type bindings *)
      val addTs : t -> (R.rep TUIdentifier.t * Type.t) list -> t
