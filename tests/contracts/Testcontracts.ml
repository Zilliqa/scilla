...
let add_tests env = 
    ...
    let mappairtests = "mappair" >:::(build_contract_tests env "mappair" succ_code 1 6) in
    let bookstoretests = "bookstore" >:::(build_contract_tests env "bookstore" succ_code 1 10) in
    let mappairtests_f = "mappair" >:::(build_contract_tests env "mappair" fail_code 7 12) in
