...
let add_tests env = 
    ...
    let simpledextests= "simple-dex" >:::(build_contract_tests env "simple-dex" succ_code 1 8) in
      "contract_tests" >::: [crowdfundingtests;cfinit_test;zilgametests;zginit_test;cfinvoketests;mappairtests; mappairtests_f;
                             ...
                             wallettests;schnorrtests;inplace_map_tests;ecdsatests;simpledextests]
