...
val get_final_finish : unit -> (string * Syntax.typ * Ipcmessage_types.proto_scilla_val) list

(* Given the interpreter's output, parse the JSON, append svars to it and print out new JSON. *)
val append_full_state : string -> (string * Syntax.typ * Ipcmessage_types.proto_scilla_val) list -> string