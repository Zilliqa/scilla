    ...
    | Some current_player =>
      ...
      | True =>
        ...
        | Resign =>
          ...
          none = None {(ByStr20)};
          player_in_turn := none;
          some_opponent = Some {(ByStr20)} opponent;
          winner := some_opponent
        | Place piece (Square row column) =>
                  ...
                  | False =>
                    ...
                    | Some Free =>
                      new_promotion_status_opt =
                        perform_promotion
                          promote promotion_status row target_row player_1_moves;
                      ...
                      | False =>
                        ...
                        | Some new_promotion_status =>
                          ...
                          | King =>
                            none = None {(ByStr20)};
                            player_in_turn := none;
                            some_current_player = Some {(ByStr20)} current_player;
                            winner := some_current_player
                          | _ =>
