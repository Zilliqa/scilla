  ...
  procedure ValidateAndConsumeCheque
    (
      token : NFT,
      price : Coins,
      fee_amount : Uint128,
      valid_direction : Side,
      cheque : Cheque
    )
    match cheque with
    | Cheque direction expiry nonce pubkey signature =>
  ...
  transition VoidCheque
    (cheque_hash : ByStr32, pubkey : ByStr33, signature : ByStr64)
    IsNotVoided cheque_hash pubkey;
  ...
  transition TransferOwnership (new_owner : ByStr20)
    ...
    e =
      {
        _eventname : "OwnershipTransferInitiated";
  ...
  transition AcceptOwnership ()
    ...
    e =
      {
        _eventname : "OwnershipTransferAccepted";
        previous_current_owner : previous_current_owner;
        current_owner : _sender
      };
    event e
  end
