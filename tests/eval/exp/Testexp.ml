...
let explist = [
  ...
  "builtin-overflow9.scilla"; "builtin4.scilla"; "builtin5.scilla"; "builtin-overflow10.scilla";
  "builtin-overflow11.scilla"; "map_to_list.scilla";
  "type_subst1.scilla"; "type_subst2.scilla"; "int_conversions.scilla";
  "int_to_nat.scilla"; "uint_conversions.scilla";
]
