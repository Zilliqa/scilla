  ...
  >::: List.map
         ...
         [
           ...
           ( "canonicalize_tfun-2",
             assert_equal ~printer:pp_typ
               (FunType
                  (PolyFun ("'_A1", TypeVar "'_A1"), PolyFun ("'_A1", TypeVar "'_A1")))
               (canonicalize_tfun
                  (FunType (PolyFun ("'X", TypeVar "'X"), PolyFun ("'X", TypeVar "'X"))))
           );
           ...
           ( "free_tvars-1",
             assert_equal ~printer:ident_list_printer ~cmp:ident_list_cmp [ asId "a" ]
           ...
           ( "free_tvars-3",
             assert_equal ~printer:ident_list_printer ~cmp:ident_list_cmp [ asId "b" ]
